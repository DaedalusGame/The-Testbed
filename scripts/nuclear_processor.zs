...
nuclear_processor.setItemSlot(1, 1, ComponentFace.all(), 64)
				 .setAccess(true, false)
				 .setGroup("input");
nuclear_processor.setItemSlot(1, 2, ComponentFace.all(), 64)
				 .setAccess(true, false)
				 .setGroup("input");
nuclear_processor.setItemSlot(1, 3, ComponentFace.all(), 64)
				 .setAccess(true, false)
				 .setGroup("input");
nuclear_processor.setFluidSlot(2, 1, ComponentFace.all(), 12000)
				 .setAccess(true, false)
				 .setGroup("input");
nuclear_processor.setFluidSlot(2, 2, ComponentFace.all(), 12000)
				 .setAccess(true, false)
				 .setGroup("input");
nuclear_processor.setFluidSlot(2, 3, ComponentFace.all(), 12000)
				 .setAccess(true, false)
				 .setGroup("input");
nuclear_processor.setItemSlot(6, 1, ComponentFace.all(), 64)
				 .setAccess(false, true)
				 .setHandAccess(false, true)
				 .setGroup("output");
nuclear_processor.setItemSlot(6, 2, ComponentFace.all(), 64)
				 .setAccess(false, true)
				 .setHandAccess(false, true)
				 .setGroup("output");
nuclear_processor.setItemSlot(6, 3, ComponentFace.all(), 64)
				 .setAccess(false, true)
				 .setHandAccess(false, true)
				 .setGroup("output");
nuclear_processor.setLaserSlot(1, 0, ComponentFace.all())
				 .setAccess(true, false)
				 .setGroup("input");
...
nuclear_processor.setJEIDurationSlot(3, 0, "duration", SlotVisual.create(1, 1).addPart("requious:textures/gui/assembly_gauges.png", 0, 8));
...
nuclear_processor.addVisual(MachineVisual.smoke("active".asVariable(),
								IVector3d.create(0, 0.25, 0.25),
								IVector3d.create(0, 0.75, 0.75),
								IVector3d.create(-0.1, 0, 0),
								Color.normal([213, 240, 15]), 30, true));
nuclear_processor.addVisual(MachineVisual.smoke("active".asVariable(),
...
function normalNPRecipe(inputItems as IIngredient[], inputFluids as ILiquidStack[], outputItems as IItemStack[], power as int){
...
function randomNPRecipe(inputItems as IIngredient[], inputFluids as ILiquidStack[], outputItems as WeightedItemStack[], power as int){
	var recipe = AssemblyRecipe.create(function(container) {
		for item in outputItems {
			if(container.jei)
